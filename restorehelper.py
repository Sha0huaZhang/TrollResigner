...
def cli(ctx, service_provider: LockdownClient) -> None:
    ...
    if (
        device_version < parse_version("16.7")
        or device_version > parse_version("17.0.1")
        ...
        click.secho("This tool is only compatible with iOS/iPadOS 16.7 (20H19) - 16.7.x and 17.0.1", fg="red")
        return
